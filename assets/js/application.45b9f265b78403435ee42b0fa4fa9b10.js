...
(()=>{
            ...
            !function(e) {
                ...
                t.length && o.on("click", (function(n) {
                    ...
                    e.ajax({
                        ...
                        o.prop("disabled", !1),
                        e.isEmptyObject(n.error) ? (t.trigger("reset"),
                        window.grecaptcha && grecaptcha.reset(),
                        toastr.success(n.success)) : toastr.error(n.error)
                    }
                    )).fail((function(e, t, o) {
                        JsLoadingOverlay.hide(),
                        toastr.error(o)
            ...
            !function(e) {
                ...
                if (t.length) {
                    var a = function() {
                        ...
                        v.files.length > 0 ? (o.addClass("inactive"),
                        n.addClass("active"),
                        e("body").addClass("overflow-hidden"),
                        w.removeClass("d-none"),
                        t.addClass("active"),
                        h.removeClass("show")) : (o.removeClass("inactive"),
                      ...
                      , r = function(e) {
                        ...
                        if (0 === e)
                            return "0 " + c.translation.formatSizes[0];
                        var o = 1024
                          , n = t < 0 ? 0 : t
                    ...
                    t.find(".btn-close").on("click", (function() {
                        v.getQueuedFiles().length > 0 || v.getUploadingFiles().length > 0 ? confirm(c.closeUploadBoxAlert) && (v.removeAllFiles(!0),
                        t.removeClass("active"),
                        e("body").removeClass("overflow-hidden")) : (v.removeAllFiles(!0),
                        t.removeClass("active"),
                    ...
                    var v = new Dropzone("#dropzone-wrapper",m)
                      , h = e(".upload-more-btn")
                        ...
                        if (v.files.length <= c.maxUploadFiles)
                            if (
                                ...
                                if (this.files.length)
                                    for (o = 0,
                                    n = this.files.length; o < n - 1; o++)
                                        this.files[o].name === t.name && (this.removeFile(t),
                                        toastr.error(c.fileDuplicateError));
                                0 == t.size && (toastr.error(c.emptyFilesError),
                                this.removeFile(t)),
                                "" != c.maxFileSize && t.size > c.maxFileSize && (toastr.error(c.exceedTheAllowedSizeError),
                                this.removeFile(t)),
                                "" != c.clientReminingSpace && t.size > c.clientReminingSpace && (toastr.error(c.clientReminingSpaceError),
                                this.removeFile(t)),
                                a(),
                                v.files.length == c.maxUploadFiles && h.addClass("d-none");
                                ...
                                f.on("click", (function() {
                                    ...
                                    m.attr("fill-status", !1),
                                    u.removeClass("fa-lock"),
                                    u.addClass("fa-lock-open")) : "false" == m.attr("fill-status") && (m.val(""),
                                    m.prop("disabled", !0),
                                    u.removeClass("fa-lock"),
                                    u.addClass("fa-lock-open")),
                                    m.removeClass("is-invalid"),
                                    s.removeClass("active")
                                }
                                )),
                                p.on("click", (function() {
                                    "" == m.val() ? m.addClass("is-invalid") : (u.addClass("fa-lock"),
                                    u.removeClass("fa-lock-open"),
                                    s.removeClass("active"))
                                }
                                ))
                            } else
                                this.removeFile(t),
                                toastr.error(c.unacceptableFileTypesError);
                        else
                            this.removeFile(t)
                    }
                    )),
                    v.on("sending", (function(t, o, n) {
                    ...
                    v.on("removedfile", (function() {
                        a()
                    }
                    )),
                    v.on("uploadprogress", (function(t, o) {
        ...
        229: ()=>{
            ...
            !function(t) {
                ...
                n.t = function(t, o) {
                    ...
                    8 & o)
                        return t;
                    if (4 & o && "object" === e(t) && t && t.__esModule)
                        return t;
                ...
                "./src/js-loading-overlay.js": function(e, t) {
                    ...
                    var n = function() {
                        ...
                        (n = [{
                            ...
                            value: function(e) {
                                ...
                                this.options.lockScroll && (document.body.style.overflow = "hidden",
                            ...
                            key: "hide",
                            value: function() {
                                this.options.lockScroll && (document.body.style.overflow = "",
                            ...
                            value: function() {
                                ...
                                var t = "50%";
                                if (0 !== this.options.offsetY && (t = "calc(50% + " + this.options.offsetY + ")"),
                                this.options.containerID && document.body.contains(document.getElementById(this.options.containerID))) {
                                    ...
                                    return n.style.position = "relative",
                                    void n.insertAdjacentHTML("beforeend", o)
                                }
                            ...
                            value: function() {
                                ...
                                e.setAttribute("id", "loading-overlay-stylesheet"),
                                e.setAttribute("rel", "stylesheet"),
                                e.setAttribute("type", "text/css"),
                                e.setAttribute("href", this.spinnerStylesheetURL),
                    ...
                    window.JsLoadingOverlay = new n,
                    e.exports = JsLoadingOverlay
                },
                0: function(e, t, o) {
        ...
        219: ()=>{
            ...
            !function(t) {
                ...
                null != a && a.forEach((function(e) {
                    function t() {
                        e.getBoundingClientRect().top + e.querySelector(".drop-down-menu").offsetHeight > window.innerHeight - 60 ? (e.querySelector(".drop-down-menu").style.top = "auto",
                        e.querySelector(".drop-down-menu").style.bottom = "40px") : (e.querySelector(".drop-down-menu").style.top = "40px",
                        e.querySelector(".drop-down-menu").style.bottom = "auto")
                    }
                    window.addEventListener("click", (function(o) {
                        e.contains(o.target) ? (e.classList.toggle("active"),
                        setTimeout((function() {
                            e.classList.toggle("animated")
                        }
                        ), 0)) : (e.classList.remove("active"),
                ...
                u && u.forEach((function(e) {
                    ...
                    t.onclick = function(e) {
                        ...
                        t.innerHTML = '<i class="fas fa-eye-slash"></i>') : (o.type = "password",
                ...
                if (document.querySelector(".fileviewer-sidebar")) {
                    var v = document.querySelector(".fileviewer-sidebar-open")
                      , h = document.querySelector(".fileviewer-sidebar-close")
                      , y = document.querySelector(".fileviewer-sidebar .overlay");
                    v.onclick = function() {
                        m.classList.add("toggle")
                    }
                    ,
                    h.onclick = y.onclick = function() {
                ...
                var b = document.querySelectorAll(".filemanager-file")
                  ...
                  , w = document.querySelector(".filemanager-select-all")
                  , k = [];
                b && b.forEach((function(t) {
                    ...
                    function i() {
                        ...
                        t.length > 0 ? g.classList.add("show") : g.classList.remove("show"),
                        t.length === b.length ? (w.checked = !0,
                        w.nextElementSibling.textContent = w.parentNode.getAttribute("data-unselect")) : (w.checked = !1,
                        w.nextElementSibling.textContent = w.parentNode.getAttribute("data-select")),
                        b.forEach((function(t) {
                            if (!0 === t.querySelector(".form-check-input").checked) {
                                k.push(t.querySelector(".form-check-input").id);
                                var o = e(new Set(k));
                    ...
                    o.onchange = function() {
                        !0 === o.checked ? (t.classList.add("selected"),
                        o.checked) : (t.classList.remove("selected"),
                        o.checked),
                        i()
                    }
                    ,
                    t.onclick = function() {
                        !0 === o.checked ? (o.checked = !1,
                    ...
                    w.onchange = function() {
                        !0 === w.checked ? b.forEach((function(e) {
                            e.querySelector(".form-check-input").checked = !0,
                            e.classList.add("selected"),
                            o.checked
                        }
                        )) : b.forEach((function(e) {
                            e.querySelector(".form-check-input").checked = !1,
                ...
                x.length && x.on("click", (function(e) {
                    ...
                    A.html("<strong>" + o.filename + "</strong>"),
                    L.html('<a href="' + n + '" target="_blank" class="social-btn social-facebook"><i class="fab fa-facebook-f"></i></a> <a href="' + a + '" target="_blank" class="social-btn social-twitter"><i class="fab fa-twitter"></i></a> <a href="' + i + '" target="_blank" class="social-btn social-whatsapp"><i class="fab fa-whatsapp"></i></a> <a href="' + r + '" target="_blank" class="social-btn social-linkedin"><i class="fab fa-linkedin"></i></a> <a href="' + l + '" target="_blank" class="social-btn social-pinterest"><i class="fab fa-pinterest"></i></a>'),
                    O.attr("value", o.share_link),
                    z.html('<iframe width="560" height="315"  src="' + o.embed_link + '" title="' + o.filename + '" frameborder="0" allowfullscreen></iframe>'),
                    E.modal("show")
                }
                ))
            }(jQuery)
    ...
    n.O = (t,o,a,i)=>{
        if (!o) {
            ...
            for (d = 0; d < e.length; d++) {
                for (var [o,a,i] = e[d], l = !0, s = 0; s < o.length; s++)
                    (!1 & i || r >= i) && Object.keys(n.O).every((e=>n.O[e](o[s]))) ? o.splice(s--, 1) : (l = !1,
                    i < r && (r = i));
                if (l) {
                    e.splice(d--, 1);
                    var c = a();
    ...
    n.O(void 0, [138, 554, 778, 188], (()=>n(124))),
    n.O(void 0, [138, 554, 778, 188], (()=>n(759))),
    n.O(void 0, [138, 554, 778, 188], (()=>n(100))),
    n.O(void 0, [138, 554, 778, 188], (()=>n(529)));
