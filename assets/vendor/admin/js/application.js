(function($) {
    ...
    $("body").on('click', '.processed_video_s3_path', function(){
        var inFramW = document.querySelector('#video_iframe').contentWindow;
        var url = $(this).attr("data-url");
        inFramW.postMessage( url, "*")
        
    })
    
    $(".original_path").click(function(){
        var inFramW = document.querySelector('#video_iframe').contentWindow;
        var url = $(this).attr("data-url");
        inFramW.postMessage( url, "*")     
    })
