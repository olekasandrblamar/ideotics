...
class UserController extends Controller
{
    ...
    public function index(Request $request, $search = null)
    {
        ...
        $verifiedUserscount = User::whereNotNull('email_verified_at')->get()->count();
        $unverifiedUserscount = User::whereNull('email_verified_at')->get()->count();
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'retailer_website' => ['required', 'string', 'max:255'],
        ...
        $createUser = User::create([
            ...
            'retailer_website' => $request->retailer_website,
