...
{
    $reasons = [
        0 => lang('Privacy, copyright or legal complaints', 'video page'),
        1 => lang('Spam or misleading', 'video page'),
        2 => lang('Malware, virus or malicious content', 'video page'),
        3 => lang('Child abuse', 'video page'),
        4 => lang('Other', 'video page'),
    ];
    return $reasons;
}
...
function fileUser($fileEntry)
{
    if ($fileEntry->user_id) {
        ...
        $data['name'] = lang('Anonymous', 'video page');
